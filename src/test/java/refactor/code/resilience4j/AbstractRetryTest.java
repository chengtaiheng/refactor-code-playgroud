...
public class AbstractRetryTest extends AbstractIntegrationTest{
    ...
    protected void  checkMerics(String kind,String backend,float count) {
    ...
    protected  static String getMetricName(String kind,String backend){
        return "resilience4j_retry_calls_tatal{application=\"reisilience4j-demo\",kind=\"" + kind+"\",name =\""+backend+"\",}";
    }
